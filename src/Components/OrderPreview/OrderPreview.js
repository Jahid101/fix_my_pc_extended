...
const OrderPreview = () => {
    ...
    useEffect(() => {
        fetch('https://pacific-wildwood-47239.herokuapp.com/orderPreview?email=' + loggedInUser.email)
            .then(res => res.json())
    ...
    return (
        <div>
            <div className="mt-3" style={{ marginLeft: '300px' }}>
                <h3 className="ml-5 mb-5 mt-5">You have {order.length} product in your Cart</h3>
